...
def get_today_statistics() -> str:
    ...
    return (f"Расходы сегодня:\n"
            f"всего — {all_today_expenses} pln.\n"
            f"базовые — {base_today_expenses} pln. из {_get_budget_limit()} pln.\n\n"
...
def get_month_statistics() -> str:
    ...
    return (f"Расходы в текущем месяце:\n"
            f"всего — {all_today_expenses} pln.\n"
            f"базовые — {base_today_expenses} pln. из "
            f"{now.day * _get_budget_limit()} pln.")
